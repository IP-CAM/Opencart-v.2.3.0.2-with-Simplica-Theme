...
--
-- Хост: localhost
-- Время создания: Дек 17 2016 г., 14:33
...
--
-- База данных: `opencart_task`
--
CREATE DATABASE IF NOT EXISTS `opencart_task` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `opencart_task`;
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_affiliate_activity`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_affiliate_login`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_affiliate_transaction`:
--
...
(1, 'Default', '', 1, '2016-12-16 13:40:53', '2016-12-16 13:40:53');
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_attribute_description`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_attribute_group`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_attribute_group_description`:
--
...
(105, 7, 1, 'iPhone', '/index.php?route=product/product&amp;product_id=40', 'catalog/demo/iphone_1.jpg', 0),
...
(106, 9, 1, 'HTC Touch HD', 'index.php?route=product/product&amp;path=24&amp;product_id=28', 'catalog/demo/htc_touch_hd_1.jpg', 0),
(104, 7, 1, 'Samsung Galaxy Tab 10.1', 'index.php?route=product/product&amp;product_id=49', 'catalog/demo/samsung_tab_1.jpg', 0),
(103, 7, 1, 'MacBookAir', 'index.php?route=product/product&amp;product_id=44', 'catalog/demo/banners/MacBookAir.jpg', 0),
(107, 9, 1, 'iPhone', 'index.php?route=product/product&amp;path=24&amp;product_id=40', 'catalog/demo/iphone_1.jpg', 0),
(108, 9, 1, 'Palm Treo Pro', 'index.php?route=product/product&amp;path=24&amp;product_id=29', 'catalog/demo/palm_treo_pro_1.jpg', 0);
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_category_description`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_category_filter`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_category_path`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_category_to_layout`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_category_to_store`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_coupon_category`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_coupon_history`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_coupon_product`:
--
...
(1, 'Pound Sterling', 'GBP', '£', '', '2', 0.80070001, 1, '2016-12-17 13:16:55'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2016-12-17 13:36:48'),
(3, 'Euro', 'EUR', '', '€', '2', 0.95660001, 1, '2016-12-17 13:16:55');
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_customer_activity`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_customer_group`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_customer_group_description`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_customer_history`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_customer_login`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_customer_online`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_customer_reward`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_customer_search`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_customer_transaction`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_customer_wishlist`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_custom_field_customer_group`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_custom_field_description`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_custom_field_value`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_custom_field_value_description`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_download_description`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_filter_description`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_filter_group_description`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_information_description`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_information_to_layout`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_information_to_store`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_layout_module`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_length_class_description`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_manufacturer_to_store`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_menu_description`:
--
...
(29, 'Home Page', 'carousel', '{"name":"Home Page","banner_id":"9","width":"100","height":"100","status":"1"}'),
(28, 'Home Page', 'featured', '{"name":"Home Page","product_name":"","product":["43","42","47","28","41"],"limit":"4","width":"260","height":"332","status":"1"}'),
(27, 'Home Page', 'slideshow', '{"name":"Home Page","banner_id":"7","width":"1140","height":"380","status":"1"}'),
(31, 'Banner 1', 'banner', '{"name":"Banner 1","banner_id":"6","width":"182","height":"182","status":"1"}'),
(33, 'Home Page Latest', 'latest', '{"name":"Home Page Latest","limit":"4","width":"260","height":"332","status":"1"}');
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_option_description`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_option_value_description`:
--
...
(1, 0, 'INV-2013-00', 0, 'Your Store', 'http://opencart_task.local/', 0, 1, 'asdf', 'asdf', 'asdf@dfg.fg', 'asdf', '', '[]', 'asdf', 'asdf', '', 'asdf', '', 'asdf', 'asdf', 'United Kingdom', 222, 'Aberdeenshire', 3514, '', '[]', 'Credit Card / Debit Card (LiqPay)', 'liqpay', '', '', '', '', '', '', '', '', 0, '', 0, '', '[]', '', '', 'vbn', '602.0000', 0, 0, '0.0000', 0, '', 1, 3, 'EUR', '0.95749998', '127.0.0.1', '', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4,uk;q=0.2', '2016-12-16 16:15:52', '2016-12-16 16:15:52');
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_order_custom_field`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_order_history`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_order_product`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_order_recurring`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_order_recurring_transaction`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_order_voucher`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_product_attribute`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_product_description`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_product_discount`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_product_filter`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_product_image`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_product_option`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_product_option_value`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_product_recurring`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_product_related`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_product_reward`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_product_special`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_product_to_category`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_product_to_download`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_product_to_layout`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_product_to_store`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_recurring_description`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_return_action`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_return_history`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_return_reason`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_return_status`:
--
...
(1385, 0, 'config', 'config_error_filename', 'error.log', 0),
(1383, 0, 'config', 'config_error_display', '1', 0),
(1384, 0, 'config', 'config_error_log', '1', 0),
(1380, 0, 'config', 'config_file_max_size', '300000', 0),
(1381, 0, 'config', 'config_file_ext_allowed', 'zip\r\ntxt\r\npng\r\njpe\r\njpeg\r\njpg\r\ngif\r\nbmp\r\nico\r\ntiff\r\ntif\r\nsvg\r\nsvgz\r\nzip\r\nrar\r\nmsi\r\ncab\r\nmp3\r\nqt\r\nmov\r\npdf\r\npsd\r\nai\r\neps\r\nps\r\ndoc', 0),
(1382, 0, 'config', 'config_file_mime_allowed', 'text/plain\r\nimage/png\r\nimage/jpeg\r\nimage/gif\r\nimage/bmp\r\nimage/tiff\r\nimage/svg+xml\r\napplication/zip\r\n&quot;application/zip&quot;\r\napplication/x-zip\r\n&quot;application/x-zip&quot;\r\napplication/x-zip-compressed\r\n&quot;application/x-zip-compressed&quot;\r\napplication/rar\r\n&quot;application/rar&quot;\r\napplication/x-rar\r\n&quot;application/x-rar&quot;\r\napplication/x-rar-compressed\r\n&quot;application/x-rar-compressed&quot;\r\napplication/octet-stream\r\n&quot;application/octet-stream&quot;\r\naudio/mpeg\r\nvideo/quicktime\r\napplication/pdf', 0),
(612, 0, 'liqpay', 'liqpay_type', 'liqpay', 0),
(611, 0, 'liqpay', 'liqpay_signature', 'bd6jTI2jEBkuy7BX0gsxIKU9ORr8gDe29X9HTsdi', 0),
(610, 0, 'liqpay', 'liqpay_merchant', 'i78228448470', 0),
(4, 0, 'voucher', 'voucher_sort_order', '8', 0),
(5, 0, 'voucher', 'voucher_status', '1', 0),
(1375, 0, 'config', 'config_compression', '0', 0),
(1376, 0, 'config', 'config_secure', '0', 0),
(1377, 0, 'config', 'config_password', '1', 0),
(1378, 0, 'config', 'config_shared', '0', 0),
(1379, 0, 'config', 'config_encryption', '', 0),
(1373, 0, 'config', 'config_seo_url', '0', 0),
(1374, 0, 'config', 'config_robots', 'abot\r\ndbot\r\nebot\r\nhbot\r\nkbot\r\nlbot\r\nmbot\r\nnbot\r\nobot\r\npbot\r\nrbot\r\nsbot\r\ntbot\r\nvbot\r\nybot\r\nzbot\r\nbot.\r\nbot/\r\n_bot\r\n.bot\r\n/bot\r\n-bot\r\n:bot\r\n(bot\r\ncrawl\r\nslurp\r\nspider\r\nseek\r\naccoona\r\nacoon\r\nadressendeutschland\r\nah-ha.com\r\nahoy\r\naltavista\r\nananzi\r\nanthill\r\nappie\r\narachnophilia\r\narale\r\naraneo\r\naranha\r\narchitext\r\naretha\r\narks\r\nasterias\r\natlocal\r\natn\r\natomz\r\naugurfind\r\nbackrub\r\nbannana_bot\r\nbaypup\r\nbdfetch\r\nbig brother\r\nbiglotron\r\nbjaaland\r\nblackwidow\r\nblaiz\r\nblog\r\nblo.\r\nbloodhound\r\nboitho\r\nbooch\r\nbradley\r\nbutterfly\r\ncalif\r\ncassandra\r\nccubee\r\ncfetch\r\ncharlotte\r\nchurl\r\ncienciaficcion\r\ncmc\r\ncollective\r\ncomagent\r\ncombine\r\ncomputingsite\r\ncsci\r\ncurl\r\ncusco\r\ndaumoa\r\ndeepindex\r\ndelorie\r\ndepspid\r\ndeweb\r\ndie blinde kuh\r\ndigger\r\nditto\r\ndmoz\r\ndocomo\r\ndownload express\r\ndtaagent\r\ndwcp\r\nebiness\r\nebingbong\r\ne-collector\r\nejupiter\r\nemacs-w3 search engine\r\nesther\r\nevliya celebi\r\nezresult\r\nfalcon\r\nfelix ide\r\nferret\r\nfetchrover\r\nfido\r\nfindlinks\r\nfireball\r\nfish search\r\nfouineur\r\nfunnelweb\r\ngazz\r\ngcreep\r\ngenieknows\r\ngetterroboplus\r\ngeturl\r\nglx\r\ngoforit\r\ngolem\r\ngrabber\r\ngrapnel\r\ngralon\r\ngriffon\r\ngromit\r\ngrub\r\ngulliver\r\nhamahakki\r\nharvest\r\nhavindex\r\nhelix\r\nheritrix\r\nhku www octopus\r\nhomerweb\r\nhtdig\r\nhtml index\r\nhtml_analyzer\r\nhtmlgobble\r\nhubater\r\nhyper-decontextualizer\r\nia_archiver\r\nibm_planetwide\r\nichiro\r\niconsurf\r\niltrovatore\r\nimage.kapsi.net\r\nimagelock\r\nincywincy\r\nindexer\r\ninfobee\r\ninformant\r\ningrid\r\ninktomisearch.com\r\ninspector web\r\nintelliagent\r\ninternet shinchakubin\r\nip3000\r\niron33\r\nisraeli-search\r\nivia\r\njack\r\njakarta\r\njavabee\r\njetbot\r\njumpstation\r\nkatipo\r\nkdd-explorer\r\nkilroy\r\nknowledge\r\nkototoi\r\nkretrieve\r\nlabelgrabber\r\nlachesis\r\nlarbin\r\nlegs\r\nlibwww\r\nlinkalarm\r\nlink validator\r\nlinkscan\r\nlockon\r\nlwp\r\nlycos\r\nmagpie\r\nmantraagent\r\nmapoftheinternet\r\nmarvin/\r\nmattie\r\nmediafox\r\nmediapartners\r\nmercator\r\nmerzscope\r\nmicrosoft url control\r\nminirank\r\nmiva\r\nmj12\r\nmnogosearch\r\nmoget\r\nmonster\r\nmoose\r\nmotor\r\nmultitext\r\nmuncher\r\nmuscatferret\r\nmwd.search\r\nmyweb\r\nnajdi\r\nnameprotect\r\nnationaldirectory\r\nnazilla\r\nncsa beta\r\nnec-meshexplorer\r\nnederland.zoek\r\nnetcarta webmap engine\r\nnetmechanic\r\nnetresearchserver\r\nnetscoop\r\nnewscan-online\r\nnhse\r\nnokia6682/\r\nnomad\r\nnoyona\r\nnutch\r\nnzexplorer\r\nobjectssearch\r\noccam\r\nomni\r\nopen text\r\nopenfind\r\nopenintelligencedata\r\norb search\r\nosis-project\r\npack rat\r\npageboy\r\npagebull\r\npage_verifier\r\npanscient\r\nparasite\r\npartnersite\r\npatric\r\npear.\r\npegasus\r\nperegrinator\r\npgp key agent\r\nphantom\r\nphpdig\r\npicosearch\r\npiltdownman\r\npimptrain\r\npinpoint\r\npioneer\r\npiranha\r\nplumtreewebaccessor\r\npogodak\r\npoirot\r\npompos\r\npoppelsdorf\r\npoppi\r\npopular iconoclast\r\npsycheclone\r\npublisher\r\npython\r\nrambler\r\nraven search\r\nroach\r\nroad runner\r\nroadhouse\r\nrobbie\r\nrobofox\r\nrobozilla\r\nrules\r\nsalty\r\nsbider\r\nscooter\r\nscoutjet\r\nscrubby\r\nsearch.\r\nsearchprocess\r\nsemanticdiscovery\r\nsenrigan\r\nsg-scout\r\nshai''hulud\r\nshark\r\nshopwiki\r\nsidewinder\r\nsift\r\nsilk\r\nsimmany\r\nsite searcher\r\nsite valet\r\nsitetech-rover\r\nskymob.com\r\nsleek\r\nsmartwit\r\nsna-\r\nsnappy\r\nsnooper\r\nsohu\r\nspeedfind\r\nsphere\r\nsphider\r\nspinner\r\nspyder\r\nsteeler/\r\nsuke\r\nsuntek\r\nsupersnooper\r\nsurfnomore\r\nsven\r\nsygol\r\nszukacz\r\ntach black widow\r\ntarantula\r\ntempleton\r\n/teoma\r\nt-h-u-n-d-e-r-s-t-o-n-e\r\ntheophrastus\r\ntitan\r\ntitin\r\ntkwww\r\ntoutatis\r\nt-rex\r\ntutorgig\r\ntwiceler\r\ntwisted\r\nucsd\r\nudmsearch\r\nurl check\r\nupdated\r\nvagabondo\r\nvalkyrie\r\nverticrawl\r\nvictoria\r\nvision-search\r\nvolcano\r\nvoyager/\r\nvoyager-hc\r\nw3c_validator\r\nw3m2\r\nw3mir\r\nwalker\r\nwallpaper\r\nwanderer\r\nwauuu\r\nwavefire\r\nweb core\r\nweb hopper\r\nweb wombat\r\nwebbandit\r\nwebcatcher\r\nwebcopy\r\nwebfoot\r\nweblayers\r\nweblinker\r\nweblog monitor\r\nwebmirror\r\nwebmonkey\r\nwebquest\r\nwebreaper\r\nwebsitepulse\r\nwebsnarf\r\nwebstolperer\r\nwebvac\r\nwebwalk\r\nwebwatch\r\nwebwombat\r\nwebzinger\r\nwhizbang\r\nwhowhere\r\nwild ferret\r\nworldlight\r\nwwwc\r\nwwwster\r\nxenu\r\nxget\r\nxift\r\nxirq\r\nyandex\r\nyanga\r\nyeti\r\nyodao\r\nzao\r\nzippp\r\nzyborg', 0),
(1372, 0, 'config', 'config_maintenance', '0', 0),
(1371, 0, 'config', 'config_mail_alert_email', '', 0),
(1364, 0, 'config', 'config_mail_parameter', 'testmailopencart@yandex.ru', 0),
(1370, 0, 'config', 'config_mail_alert', '["order"]', 1),
(1369, 0, 'config', 'config_mail_smtp_timeout', '5', 0),
(1368, 0, 'config', 'config_mail_smtp_port', '465', 0),
(1367, 0, 'config', 'config_mail_smtp_password', 'rhtvtyxeu', 0),
(1366, 0, 'config', 'config_mail_smtp_username', 'testmailopencart', 0),
(1365, 0, 'config', 'config_mail_smtp_hostname', 'ssl://smtp.yandex.ru', 0),
(1363, 0, 'config', 'config_mail_protocol', 'smtp', 0),
...
(1357, 0, 'config', 'config_ftp_hostname', 'opencart_task.local', 0),
(1356, 0, 'config', 'config_icon', 'catalog/cart.png', 0),
(1355, 0, 'config', 'config_logo', 'catalog/logo.png', 0),
(1354, 0, 'config', 'config_captcha_page', '["review","return","contact"]', 1),
(1353, 0, 'config', 'config_captcha', '', 0),
(1352, 0, 'config', 'config_return_status_id', '2', 0),
(1351, 0, 'config', 'config_return_id', '0', 0),
(1350, 0, 'config', 'config_affiliate_id', '4', 0),
(1349, 0, 'config', 'config_affiliate_commission', '5', 0),
(1348, 0, 'config', 'config_affiliate_auto', '0', 0),
(1347, 0, 'config', 'config_affiliate_approval', '0', 0),
(1346, 0, 'config', 'config_stock_checkout', '0', 0),
...
(222, 0, 'theme_default', 'theme_default_image_cart_height', '60', 0),
(221, 0, 'theme_default', 'theme_default_image_cart_width', '47', 0),
(220, 0, 'theme_default', 'theme_default_image_wishlist_height', '60', 0),
(219, 0, 'theme_default', 'theme_default_image_wishlist_width', '47', 0),
(218, 0, 'theme_default', 'theme_default_image_compare_height', '115', 0),
(217, 0, 'theme_default', 'theme_default_image_compare_width', '90', 0),
(216, 0, 'theme_default', 'theme_default_image_related_height', '332', 0),
(215, 0, 'theme_default', 'theme_default_image_related_width', '260', 0),
(214, 0, 'theme_default', 'theme_default_image_additional_height', '94', 0),
(213, 0, 'theme_default', 'theme_default_image_additional_width', '74', 0),
(212, 0, 'theme_default', 'theme_default_image_product_height', '332', 0),
(211, 0, 'theme_default', 'theme_default_image_product_width', '260', 0),
(210, 0, 'theme_default', 'theme_default_image_popup_height', '638', 0),
(209, 0, 'theme_default', 'theme_default_image_popup_width', '500', 0),
(207, 0, 'theme_default', 'theme_default_image_thumb_width', '260', 0),
(208, 0, 'theme_default', 'theme_default_image_thumb_height', '332', 0),
(206, 0, 'theme_default', 'theme_default_image_category_height', '102', 0),
(205, 0, 'theme_default', 'theme_default_image_category_width', '80', 0),
(204, 0, 'theme_default', 'theme_default_product_description_length', '100', 0),
...
(1345, 0, 'config', 'config_stock_warning', '0', 0),
(1344, 0, 'config', 'config_stock_display', '0', 0),
(1343, 0, 'config', 'config_api_id', '1', 0),
(1342, 0, 'config', 'config_fraud_status_id', '7', 0),
(1341, 0, 'config', 'config_complete_status', '["5","3"]', 1),
(1340, 0, 'config', 'config_processing_status', '["5","1","2","12","3"]', 1),
(1339, 0, 'config', 'config_order_status_id', '1', 0),
(1338, 0, 'config', 'config_checkout_id', '5', 0),
(1337, 0, 'config', 'config_checkout_guest', '1', 0),
(1336, 0, 'config', 'config_cart_weight', '1', 0),
(1335, 0, 'config', 'config_invoice_prefix', 'INV-2013-00', 0),
(1334, 0, 'config', 'config_account_id', '3', 0),
(1333, 0, 'config', 'config_login_attempts', '5', 0),
(1332, 0, 'config', 'config_customer_price', '0', 0),
(1331, 0, 'config', 'config_customer_group_display', '["1"]', 1),
(1330, 0, 'config', 'config_customer_group_id', '1', 0),
(1329, 0, 'config', 'config_customer_search', '0', 0),
(1328, 0, 'config', 'config_customer_activity', '0', 0),
(223, 0, 'theme_default', 'theme_default_image_location_width', '268', 0),
(203, 0, 'theme_default', 'theme_default_product_limit', '15', 0),
(202, 0, 'theme_default', 'theme_default_status', '1', 0),
(201, 0, 'theme_default', 'theme_default_directory', 'simplica', 0),
(224, 0, 'theme_default', 'theme_default_image_location_height', '50', 0),
(1327, 0, 'config', 'config_customer_online', '0', 0),
(1326, 0, 'config', 'config_tax_customer', 'shipping', 0),
(1324, 0, 'config', 'config_tax', '1', 0),
(1325, 0, 'config', 'config_tax_default', 'shipping', 0),
(1323, 0, 'config', 'config_voucher_max', '1000', 0),
(1322, 0, 'config', 'config_voucher_min', '1', 0),
(1321, 0, 'config', 'config_review_guest', '1', 0),
(1320, 0, 'config', 'config_review_status', '1', 0),
(1319, 0, 'config', 'config_limit_admin', '20', 0),
(1318, 0, 'config', 'config_product_count', '1', 0),
(1317, 0, 'config', 'config_weight_class_id', '1', 0),
(1316, 0, 'config', 'config_length_class_id', '1', 0),
(1315, 0, 'config', 'config_currency_auto', '1', 0),
(1314, 0, 'config', 'config_currency', 'USD', 0),
(1313, 0, 'config', 'config_admin_language', 'en-gb', 0),
(1312, 0, 'config', 'config_language', 'en-gb', 0),
(1311, 0, 'config', 'config_zone_id', '3563', 0),
(1310, 0, 'config', 'config_country_id', '222', 0),
(1309, 0, 'config', 'config_comment', '', 0),
(1308, 0, 'config', 'config_open', '', 0),
(1307, 0, 'config', 'config_image', '', 0),
(1306, 0, 'config', 'config_fax', '', 0),
(1305, 0, 'config', 'config_telephone', '123456789', 0),
(1304, 0, 'config', 'config_email', 'testmailopencart@yandex.ru', 0),
(1303, 0, 'config', 'config_geocode', '50.441688, 30.512908', 0),
(1302, 0, 'config', 'config_company_position', '1', 0),
(1301, 0, 'config', 'config_company_bic', '', 0),
(1300, 0, 'config', 'config_company_iban', '', 0),
(1299, 0, 'config', 'config_company_tax_id', '', 0),
(1298, 0, 'config', 'config_company_id', '', 0),
(321, 0, 'information', 'information_status', '1', 0),
(1297, 0, 'config', 'config_address', 'Address 1', 0),
(1296, 0, 'config', 'config_owner', 'Your Name', 0),
(1295, 0, 'config', 'config_name', 'Your Store', 0),
(1294, 0, 'config', 'config_layout_id', '4', 0),
(613, 0, 'liqpay', 'liqpay_total', '', 0),
(614, 0, 'liqpay', 'liqpay_order_status_id', '2', 0),
(615, 0, 'liqpay', 'liqpay_geo_zone_id', '0', 0),
(616, 0, 'liqpay', 'liqpay_status', '1', 0),
(617, 0, 'liqpay', 'liqpay_sort_order', '', 0),
(1293, 0, 'config', 'config_theme', 'theme_default', 0),
(1292, 0, 'config', 'config_meta_keyword', '', 0),
(1291, 0, 'config', 'config_meta_description', 'My Store', 0),
(1290, 0, 'config', 'config_meta_title', 'Your Store', 0);
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_tax_rate_to_customer_group`:
--
...
(1, 1, 'admin', 'd38c0cb7b41b763acae4b7eabbfdcca16e1ca0be', '8WJSZEyVC', 'John', 'Doe', 'seyz777@gmail.com', '', '', '127.0.0.1', 1, '2016-12-16 13:40:53');
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_voucher_history`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_voucher_theme`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_voucher_theme_description`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_weight_class_description`:
--
...
--
-- СВЯЗИ ТАБЛИЦЫ `oc_zone_to_geo_zone`:
--
